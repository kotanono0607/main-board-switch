/* ===============================================================
 * KANBAN INLINE SCRIPT
 * Pleasanter カスタムスクリプト用 - <script>タグ内に直接記述可能
 *
 * 使用方法：
 * このファイルの内容全体を <script> タグ内にコピー＆ペースト
 * ============================================================= */
...
(function (w) {
  ...
  async function 保存(detail) {
    ...
    try {
      ...
      console.log(`▶ 保存成功 id=${id} (${area}) パーセンテージ=${percentX}%, ${percentY}%`);
    } catch (e) {
